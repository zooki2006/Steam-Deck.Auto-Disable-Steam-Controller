...
#Match any version of Deck Controls ref: https://github.com/scawp/Steam-Deck.Auto-Disable-Steam-Controller/issues/10#issuecomment-2036096703
if [[ "$5" = "3/28de/1205/"* ]];then
